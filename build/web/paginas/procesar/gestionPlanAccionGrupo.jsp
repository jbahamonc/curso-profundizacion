...
<%
    ...
    switch (operacion) {
        ...
        case 3:
            a�o = request.getParameter("a�o");
            semestre = request.getParameter("semestre");            
            JSONObject res = f.registrarInicialPlanAccionGrupo(a�o, semestre, id_grupo, token);
            if ( res != null ) {
                res.put("status", 200);
            } else {
                res = new JSONObject();
        ...
        case 4:
            ...
            boolean bool = f.vincularProyectoPlanGrupo(a�o, semestre, id_grupo, id_proyecto, token);
        ...
        case 5:
            ...
            boolean respuesta = f.registrarEventoPlanAccionGrupo(a�o, semestre, id_grupo, evento, caracterEvento, responsables, fechaIni, 
        ...
        case 6:
            ...
            boolean rsp = f.registrarActividadPlanAccionGrupo(a�o, semestre, id_grupo, actividad, respAct, fechaInicio, fechFinal, 
                    producto, token);
        ...
        case 7:
            ...
            boolean r = f.registroAvanceActividadPlan(a�o, semestre, id_grupo, id_actividad, porcentaje, token);
        ...
        case 8:
            ...
            boolean re = f.registroAvanceEventoPlan(a�o, semestre, id_grupo, id_evento, por, token);
        ...
        case 9:
            a�o = request.getParameter("a�o");
            semestre = request.getParameter("semestre"); 
            JSONObject infoPlan = f.consultarPlanAccionGrupo(a�o, semestre, id_grupo, token);
            if ( infoPlan == null ) {
